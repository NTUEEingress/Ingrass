...
function SetPortalEffect() {
	...
	PortalEffect[3] = 0;
	PortalEffect[4] = 0;
	//-1: random, 0: speed buff, 1: score buff, 2: 100 points, 3: speed up control
	//effect 0~3, reset all portals, remove all buffs, cannot control, enemy cannot control
	/*
	   PortalEffect[1] = 0;
	   PortalEffect[2] = 1;
	   PortalEffect[3] = 2;
